...
function mountNintendo(document: Document, window: Window): () => void {
  ...
  const open = (): void => {
    ...
    hints.innerHTML = '<div data-dsh-nintendo-p1><span><b>P1</b> <kbd>WASD</kbd> 移动</span><span><kbd>X</kbd> A</span><span><kbd>Z</kbd> B</span><span><kbd>Enter</kbd> Start</span><span><kbd>右 Ctrl</kbd> Select</span></div><div data-dsh-nintendo-p2><span><b>P2</b> <kbd>↑↓←→</kbd> 移动</span><span><kbd>1</kbd> A</span><span><kbd>2</kbd> B</span><span><kbd>3</kbd> Start</span><span><kbd>4</kbd> Select</span></div>'
